    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">[Varshini]</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">[Dhandoo's]'s</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — [Nishaa] 💖</h2>
